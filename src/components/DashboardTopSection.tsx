...
const DashboardTopSection = () => {
    return (
        <div className="w-full flex lg:flex-row flex-col gap-8 justify-between">
            <div className="h-full w-full lg:w-[60%] grid lg:grid-cols-4  sm:grid-cols-2 grid-cols-1 gap-6">
                {
            ...
            <Card className="h-full w-full lg:w-[40%] p-4 flex sm:flex-row flex-col justify-between items-start">
                <section className="flex w-full h-full flex-col justify-between items-start gap-4">
                    <h1>Net Profit</h1>
